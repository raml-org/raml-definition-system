...
export class Library extends LibraryBase {
    ...
    name: string;
    $name=[MetaModel.key(),MetaModel.description("Namespace which the library is imported under")]
}
    ...
    export class LibraryBase extends Common.RAMLLanguageElement{
        ...
        annotationTypes:declarations.AnnotationTypeDeclaration[];
        $annotationTypes=[
    ...
    class Api extends LibraryBase{
        ...
        RAMLVersion:string
        $RAMLVersion = [MetaModel.customHandling(), MetaModel.description("Returns RAML version. \"RAML10\" string is returned for RAML 1.0. \"RAML08\" string is returned for RAML 0.8.")]
    }
