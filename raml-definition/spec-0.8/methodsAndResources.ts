...
To indicate that the method may be called without applying any securityScheme, the method may be annotated with the null securityScheme.`)]
    ...
    displayName: string
    $displayName=[MetaModel.description("An alternate, human-friendly name for the resource type")]
...
export class Method extends MethodBase{
    ...
    $method=[MetaModel.key(),
        ...
        MetaModel.oneOf(["get","put","post","delete","patch","options","head","trace","connect"]),MetaModel.description("Method that can be called")]
