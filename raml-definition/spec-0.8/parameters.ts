...
export class Parameter extends Common.RAMLLanguageElement{
    ...
    displayName: string
    $displayName=[MetaModel.description("An alternate, human-friendly name for the parameter")]
...
export class StringTypeDeclaration extends Parameter{
    ...
    minLength:number
    $minLength=[
        MetaModel.description("(Optional, applicable only for parameters of type string) The minLength attribute specifies the parameter value's minimum number of characters.")]
    maxLength:number
...
export class HasNormalParameters extends Common.RAMLLanguageElement{
    ...
    displayName:string
    $displayName = [MetaModel.description("An alternate, human-readable name of the object")]
